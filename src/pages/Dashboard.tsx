...
import { Calendar, Users, Stethoscope, FileText, Package, MapPin, ShieldAlert } from "lucide-react";
...
export default function Dashboard() {
  ...
  useEffect(() => {
    (async () => {
      ...
      const alertas = (estoque ?? []).filter((i) => Number(i.quantidade_atual) <= Number(i.quantidade_minima)).length;
